...
"""
	This file defines helper functions for authenticating so that the outlook
	api can be used
"""

# Client ID and secret
client_id = '265a6e90-8da2-4b38-84fe-f4e3d3864927'
client_secret = '4dxKuSbdgg0Lv4dfZHauZwr'
...
# gets a token from the returned authentication code, used to access user's 
# email, and other things from outlook
